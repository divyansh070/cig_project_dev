    ...
    <div className="min-h-screen flex flex-col relative overflow-hidden">
      <nav className="p-6 flex justify-between items-center max-w-7xl mx-auto w-full relative z-10">
        ...
        >
          ...
          <Link href="/register" className="group relative px-6 py-2.5 rounded-full overflow-hidden shadow-sm">
      ...
      <main className="flex-grow flex flex-col items-center justify-center p-6 text-center relative z-10 mt-10 md:mt-0">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <Link href="/login" className="px-8 py-4 bg-white hover:bg-gray-50 text-gray-900 border border-gray-200 rounded-full font-semibold text-lg transition-all shadow-sm hover:-translate-y-1 flex items-center gap-2 w-full sm:w-auto justify-center">
              Member Sign In
            </Link>
          </div>
        </motion.div>
          ...
          {[
            ...
            <div key={i} className="group relative glass-panel p-8 rounded-3xl text-left border border-black/5 hover:border-primary/20 transition-all duration-500 overflow-hidden">
              ...
              <div className="relative z-10">
                <div className="bg-white w-14 h-14 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 group-hover:bg-primary/10 shadow-sm border border-black/5 transition-all duration-500">
